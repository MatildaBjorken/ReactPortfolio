    ...
    <div className="about">
      ...
      <div className="about-img">
        ...
        <p className="about-text">
          ...
          reason, I am looking for an internship as well as a temporary project
          to contribute to. In return, I would offer my full commitment, be an
          optimistic and ambitious addition to your team!
        </p>
      </div>
      ...
      <div className="about-letter">
        ...
        <p className="about-contact">
          ...
          <br></br>
          <br></br>
          <a className="about-mail" href="mailto:matilda.bjork@hyperisland.se">
